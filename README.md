...
| Time (GMT) | Flag        | Stage             | Event / Artifact                                                                                                   |
| ---------- | ----------- | ----------------- | ------------------------------------------------------------------------------------------------------------------ |
...
| 02:26:01   | **Flag 20** | Anti-Forensics    | PowerShell history file deleted → `ConsoleHost_history.txt`                                                        |
...
Objective: 159.26.106.98

Query used: (Timestamped 2025-11-22T00:27:58.4166424Z)
```
DeviceLogonEvents
